...
export default function SearchOverlay({ open, onSelect, onClose, filterCount = 0, onFilterClick }) {
          ...
          results.map((r) => (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-[0.95rem] font-semibold text-ink">{r.place_name}</span>
                {r.address_name && (
